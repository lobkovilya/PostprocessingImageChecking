...
urls_file = "txt/fishes_urls.txt"
modified_urls_file = "txt/modified_fishes_urls.txt"
...
for desc in itertools.islice(image_descriptors, 0, 3):
    ...
    image_descriptors = upload_images_to_cloud(applier.apply(image))
    save_to_file(modified_urls_file, image_descriptors)
